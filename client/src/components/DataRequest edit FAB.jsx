...
const DataRequest = ({ user, filter }) => {
  ...
  const handleActionFab = async (
    ...
    if (statusBaru === 'Rejected') {
      ...
      alasan = prompt(
        "Masukkan alasan penolakan untuk No. FAB #" + no_fab
      );
    ...
    try {
      ...
      const response = await fetch(
        `http://localhost:5000/api/permintaan/fab/${no_fab}`,
        {
          method: 'PUT',
      ...
      if (response.ok) {
        ...
        alert(
          `FAB #${no_fab} berhasil diupdate ke status: ${statusBaru}`
        );
                  ...
                  <td style={s.td}>
                    ...
                    <div style={{
                      ...
                      {['logistik', 'admin']
                        .includes(user?.role)
                        &&
                        fab.status_approval === 'Closed'
                        && (
                          <button
                            onClick={() =>
                              handlePrintManual(fab)
                            }
                            style={{
                              ...s.btnA,
